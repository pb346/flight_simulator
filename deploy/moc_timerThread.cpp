...
#include "../../flight_simulator/src/timerThread.h"
...
QT_MOC_LITERAL(3, 23, 15) // "joystick_event*"

    },
    "timerThread\0updateGUI\0\0joystick_event*"
};
...
void timerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateGUI((*reinterpret_cast< joystick_event*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (timerThread::*_t)(joystick_event * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&timerThread::updateGUI)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject timerThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_timerThread.data,
      qt_meta_data_timerThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void timerThread::updateGUI(joystick_event * _t1)
{
